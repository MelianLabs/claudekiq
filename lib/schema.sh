  ...
  cat <<'SCHEMA'
{
  ...
  "todos":{"d":"List pending human actions across all runs","u":"cq todos [--flow <run_id>]","p":[],"a":[["--flow","string",false,"Filter by run ID"]],"f":["--json"],"e":["cq todos","cq todos --flow a1b2c3d4"]},
